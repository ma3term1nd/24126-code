...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -303.9209241733963; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 764.8975335575718; // x position of the perpendicular encoder (in tick units)
    }
