...
public class TeleOpV1 extends OpMode { //adb connect 192.168.43.1:5555
    ...
    boolean lastIntake2ButtonState = false;
    boolean lastIntakeButtonState = false;
    boolean currentIntake2ButtonState = false;
    ...
    public void  loop() {
        ...
        boolean currentIntake2ButtonState = gamepad2.x;

        if(currentIntake2ButtonState && !lastIntake2ButtonState){
        ...
        lastIntake2ButtonState = currentIntake2ButtonState;
        /* OUT-TAKE */
